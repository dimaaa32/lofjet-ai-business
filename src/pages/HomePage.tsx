      ...
      <section className="relative min-h-screen bg-gradient-to-br from-[#0A0A1F] via-[#1A1A2E] to-[#16213E] overflow-hidden">
        ...
        <div className="container-custom relative z-10 h-screen flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
            ...
            >
              <motion.h1 
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] mb-8 relative"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Link 
                  to="/contact"
                  className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gradient-to-r from-[#845AFF] via-purple-600 to-blue-600 hover:from-purple-600 hover:via-blue-600 hover:to-cyan-500 text-white font-bold text-base sm:text-lg transition-all duration-500 shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105 overflow-hidden min-h-[56px] w-full sm:w-auto"
                >
                  ...
                  <div className="relative flex items-center justify-center w-full">
                    <motion.div className="mr-2 sm:mr-3 flex-shrink-0">
                      <Sparkles className="h-5 w-5 sm:h-6 sm:w-6" />
                    </motion.div>
                    <span className="text-center leading-tight">Get My Free Strategy & Demo</span>
                    <ArrowRight className="h-5 w-5 sm:h-6 sm:w-6 ml-2 sm:ml-3 group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" />
                  </div>
            ...
            <motion.div
              className="relative px-6 mt-16 block lg:hidden"
            ...
            >
              <div className="relative w-full max-w-xs mx-auto">
                ...
                <motion.div
                  className="relative w-full h-80 mx-auto overflow-hidden rounded-3xl shadow-2xl"
                  animate={{
                    rotateY: [0, 3, -3, 0],
                  }}
                  transition={{
