...
const HomePage = () => {
  return (
    <>
        ...
        <div className="container-custom relative z-10 h-screen flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
            ...
            <motion.div
              ...
              className="text-center lg:text-left pt-20 lg:pt-0 px-4 lg:px-0"
            >
              <motion.h1 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] mb-6 relative"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.3 }}
              >
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-cyan-300 mb-2">
                  Your 24/7
                </span>
              ...
              <motion.p 
                className="text-base sm:text-lg lg:text-xl text-gray-300 mb-8 lg:mb-12 leading-relaxed max-w-2xl mx-auto lg:mx-0"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Link 
                  to="/contact"
                  className="group relative w-full sm:w-auto px-6 sm:px-8 py-4 sm:py-5 rounded-2xl bg-gradient-to-r from-[#845AFF] via-purple-600 to-blue-600 hover:from-purple-600 hover:via-blue-600 hover:to-cyan-500 text-white font-bold text-base sm:text-lg transition-all duration-500 shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105 flex items-center justify-center overflow-hidden"
                >
                  ...
                  <div className="relative flex items-center">
                    <motion.div className="mr-3"><Sparkles className="h-5 w-5 sm:h-6 sm:w-6" /></motion.div>
                    <span className="text-center">Get My Free Strategy & Demo</span>
            ...
            <motion.div
              className="relative px-4 mt-12 block lg:hidden"
            ...
            >
              <div className="relative w-full max-w-sm mx-auto">
                ...
                <motion.div
                  className="relative w-full h-96 mx-auto overflow-hidden rounded-3xl shadow-2xl"
                  animate={{
                    rotateY: [0, 3, -3, 0],
                  }}
                  transition={{
                ...
                >
                  ...
                  >
                    <div className="w-full h-full rounded-3xl bg-gradient-to-br from-[#845AFF] via-purple-900 to-blue-800 overflow-hidden relative">
      ...
      <section id="results" className="py-16 sm:py-20 bg-gradient-to-r from-gray-900 to-[#0A0A1F]">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#845AFF] mb-4 leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8 px-4">
            ...
            <ResultCard number="+35%" title="More Leads with Our Stack" delay={0.2} />
      ...
      <section className="py-16 sm:py-24 bg-[#0A0A1F] relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 sm:mb-8 text-white leading-tight">
              Pick Your Profit Machine
            </h2>
          </motion.div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6 px-4">
            <AIServiceCard 
              icon={<MessageSquare className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-[#845AFF]" />}
              title="AI Chatbots"
            ...
            />
            <AIServiceCard 
              icon={<Phone className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-green-400" />}
            ...
            />
            <AIServiceCard 
              icon={<Target className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-blue-400" />}
            ...
            />
            <AIServiceCard 
              icon={<Mail className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-purple-400" />}
            ...
            />
            <AIServiceCard 
              icon={<Monitor className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-orange-400" />}
      ...
      <section className="py-16 sm:py-20 bg-[#0A0A1F]">
        <div className="container-custom">
          <motion.div 
            className="text-center mb-12 sm:mb-16 px-4"
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 px-4">
            <BenefitCard icon={<DollarSign className="h-6 w-6 sm:h-8 sm:w-8 text-green-400" />} title="Save $1K–$2K/month on payroll" delay={0} />
            <BenefitCard icon={<TrendingUp className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400" />} title="Close 2x more leads without hiring" delay={0.1} />
            <BenefitCard icon={<Zap className="h-6 w-6 sm:h-8 sm:w-8 text-yellow-400" />} title="Launch in days, not months" delay={0.2} />
            <BenefitCard icon={<Shield className="h-6 w-6 sm:h-8 sm:w-8 text-purple-400" />} title="Plug-and-play tools - no devs headaches" delay={0.3} />
            <BenefitCard icon={<Award className="h-6 w-6 sm:h-8 sm:w-8 text-orange-400" />} title="Results in 30 days - or full refund" delay={0.4} />
            <BenefitCard icon={<Heart className="h-6 w-6 sm:h-8 sm:w-8 text-pink-400" />} title="Personalized onboarding and strategy" delay={0.5} />
          </div>
        </div>
      </section>

      {/* Who This Is For Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-gray-900 via-[#0A0A1F] to-gray-900">
        <div className="container-custom">
          <motion.div 
            className="text-center mb-12 sm:mb-16 px-4"
            initial={{ opacity: 0, y: 20 }}
      ...
      {/* Final CTA Section */}
      <section className="relative py-16 sm:py-24 bg-gradient-to-r from-[#845AFF] to-purple-600 text-white overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-5xl mx-auto text-center px-4">
            ...
            <motion.p 
              className="text-lg sm:text-xl md:text-2xl lg:text-3xl mb-12 sm:mb-16 max-w-4xl mx-auto leading-relaxed opacity-90"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <Link 
                to="/contact"
                className="group w-full sm:w-auto px-8 sm:px-12 lg:px-16 py-4 sm:py-5 lg:py-6 rounded-xl bg-white text-[#845AFF] hover:bg-gray-100 font-bold text-lg sm:text-xl lg:text-2xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center"
              >
                <Sparkles className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 mr-3 sm:mr-4 group-hover:animate-pulse" />
                Show Me the Money Map
                <ArrowRight className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 ml-3 sm:ml-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </motion.div>
          </div>
        </div>
...
const AIServiceCard = ({ icon, title, description, cta, link, delay }) => {
  return (
    <motion.div 
      className="group relative bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-4 sm:p-6 lg:p-8 hover:bg-gray-900/70 hover:border-[#845AFF]/30 transition-all duration-500 flex flex-col h-full overflow-hidden"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
    ...
    >
      <div className="relative z-10">
        <div className="inline-flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 rounded-2xl bg-gray-800/50 border border-gray-700/50 mb-4 sm:mb-6 group-hover:bg-gray-800/70 transition-all duration-300">
          {icon}
        </div>
        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-4 group-hover:text-[#845AFF] transition-colors">
          {title}
        </h3>
        <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-6 lg:mb-8 leading-relaxed flex-grow">{description}</p>
        <Link 
          to={link}
          className="group/btn relative w-full px-4 sm:px-6 py-3 sm:py-4 rounded-xl bg-[#845AFF] hover:bg-purple-600 text-white font-bold text-sm sm:text-base transition-all duration-300 shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 flex items-center justify-center overflow-hidden"
        >
          <span className="relative z-10 flex items-center">
            <Sparkles className="h-4 w-4 sm:h-5 sm:w-5 mr-2 sm:mr-3" />
            <span>{cta}</span>
            <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 ml-2 sm:ml-3 group-hover/btn:translate-x-1 transition-transform" />
          </span>
        </Link>
      </div>
    </motion.div>
...
const ResultCard = ({ number, title, delay }) => {
  return (
    <motion.div 
      className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-4 sm:p-6 lg:p-8 text-center hover:bg-gray-800/70 hover:border-[#845AFF]/30 transition-all duration-300"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6, delay }}
    >
      <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#845AFF] to-purple-400 mb-2 sm:mb-4 leading-tight">
        {number}
      </div>
      <h3 className="text-sm sm:text-base lg:text-lg font-bold text-white leading-tight">{title}</h3>
    </motion.div>
  );
};
...
const BenefitCard = ({ icon, title, delay }) => {
  return (
    <motion.div 
      className="flex items-center bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-4 sm:p-6 hover:bg-gray-800/70 hover:border-[#845AFF]/30 transition-all duration-300"
      initial={{ opacity: 0, x: -20 }}
      whileInView={{ opacity: 1, x: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6, delay }}
    >
      <div className="flex-shrink-0 mr-3 sm:mr-4">{icon}</div>
      <div><h4 className="font-bold text-white text-sm sm:text-base leading-tight">{title}</h4></div>
    </motion.div>
  );
};
...
const WhoCard = ({ icon, title, description, delay }) => {
  return (
    <motion.div 
      className="bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-4 sm:p-6 lg:p-8 hover:bg-gray-900/70 hover:border-[#845AFF]/30 transition-all duration-300 group text-center"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6, delay }}
    >
      ...
      <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3 group-hover:text-[#845AFF] transition-colors leading-tight">
        {title}
      </h3>
